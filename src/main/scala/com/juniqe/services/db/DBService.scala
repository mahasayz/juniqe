...
trait MockDBService extends DBService {
  def getSizes: Future[Seq[ISize]] = Future {
    Seq(
      ...
      ISize(20,30,Orientations.Landscape), ISize(40,60,Orientations.Landscape), ISize(60,90,Orientations.Landscape), ISize(80,120,Orientations.Landscape), ISize(100,150,Orientations.Landscape),
      ISize(30,20,Orientations.Portrait), ISize(60,40,Orientations.Portrait), ISize(90,60,Orientations.Portrait), ISize(120,80,Orientations.Portrait), ISize(150,100,Orientations.Portrait)
    )
  }
}